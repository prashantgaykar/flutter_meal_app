...
class MealDetailsScreen extends ConsumerWidget {
  ...
  void _changeFavoriteMealStatus(BuildContext context, WidgetRef ref) {
    final isFavorite =
        ref.read(favoriteMelasProvider.notifier).toggleMealFavoriteStatus(meal);
    _showInfoMessage(
        (isFavorite ? 'Meal is marked as favorite.' : 'Meal is removed.'),
        context);
  }
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
                onPressed: () {
                  _changeFavoriteMealStatus(context, ref);
                },
